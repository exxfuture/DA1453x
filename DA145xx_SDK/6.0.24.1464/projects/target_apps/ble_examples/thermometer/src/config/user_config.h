...
#define USER_ADVERTISE_DATA         ("\x03"\
                                    ...
                                    ADV_UUID_HEALTH_THERMOMETER_SERVICE)

/// Advertising data length - maximum 28 bytes, 3 bytes are reserved to set
#define USER_ADVERTISE_DATA_LEN               (sizeof(USER_ADVERTISE_DATA)-1)

/// Scan response data
#define USER_ADVERTISE_SCAN_RESPONSE_DATA     "\x0b"\
 ...
 */
/// Device name
#define USER_DEVICE_NAME        "DLG_THRM"
...
static const struct default_handlers_configuration  user_default_hnd_conf = {
    ...
    // It is measured in timer units (1 min). Use MS_TO_TIMERUNITS macro to convert
    // from milliseconds (ms) to timer units.
    .advertise_period = MS_TO_TIMERUNITS(60000),
