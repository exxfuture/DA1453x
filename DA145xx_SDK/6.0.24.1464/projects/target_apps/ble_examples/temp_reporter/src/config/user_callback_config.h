...
// Removed duplicate - see below for correct BAS callback definition
...
#if (BLE_HT_THERMOM)
static const struct app_htpt_cb user_app_htpt_cb = {
    .on_htpt_ind_cfg_ind            = user_htpt_ind_cfg_ind,
    .on_htpt_send_measurement_cfm   = user_htpt_send_measurement_cfm,
    .on_htpt_send_intv_chg_cfm      = user_htpt_meas_intv_chg_cfm,
};
