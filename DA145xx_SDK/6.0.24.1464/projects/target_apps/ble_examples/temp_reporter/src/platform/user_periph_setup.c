...
*/
    ...
    // Temperature sensor ADC input on P0_6
    RESERVE_GPIO(TEMP_ADC, GPIO_PORT_0, GPIO_PIN_6, PID_ADC);
...
*/
    ...
    // Temperature sensor ADC input on P0_6
    GPIO_ConfigurePin(GPIO_PORT_0, GPIO_PIN_6, INPUT, PID_ADC, false);
...
#if (BLE_HT_THERMOM)
    // Temperature reporter specific initialization
    app_button_enable();
#endif
