 ...
 * @file user_tempr.h
 *
 * @brief Temperature Reporter Project application header file.
 *
...
#ifndef _USER_TEMPR_H_
#define _USER_TEMPR_H_
...
#define CFG_EXT_SLEEP_WAKEUP_TIMER1
...
/// Default temperature measurement interval in milliseconds
#define TEMP_MEAS_INTERVAL_DEFAULT      5000

/// Minimum temperature measurement interval in milliseconds  
#define TEMP_MEAS_INTERVAL_MIN          1000

/// Maximum temperature measurement interval in milliseconds
#define TEMP_MEAS_INTERVAL_MAX          60000
...
/**
 ****************************************************************************************
 * @brief Read temperature from internal sensor and send measurement.
 ****************************************************************************************
*/
 ...
 * @param[in] conidx Connection index
 * @param[in] intv   New measurement interval in seconds
 ****************************************************************************************
 */
 ...
 * @param[in] conidx Connection index
 * @param[in] ind_en Indication enabled/disabled
 ****************************************************************************************
 */
 ...
 * @brief HTPT measurement interval change confirmation callback
 * @param[in] conidx Connection index
 * @param[in] intv New measurement interval
 ****************************************************************************************
*/
void user_htpt_meas_intv_chg_cfm(uint8_t conidx, uint16_t intv);

#if defined (__DA14531__) && defined (CFG_EXT_SLEEP_WAKEUP_TIMER1)
/**
 ****************************************************************************************
